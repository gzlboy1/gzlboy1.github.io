...
rm.showRightMenu = function (isTrue, x = 0, y = 0) {
  ...
  if (isTrue) {
    ...
    $rightMenu.hide();
    $('#menu-archive').attr('style', 'display: block');
    $('#menu-folder').attr('style', 'display: block');
    $('#menu-tags').attr('style', 'display: block');
    $('#menu-copy').attr('style', 'display: none');
    $('#menu-search').attr('style', 'display: none');
  }
};
...
$('#menu-darkmode').on('click', function () { removeRightMenu(); switchNightMode() });
...
function selceText() {
  ...
  if (txt) {
    $('#menu-copy').attr('style', 'display: block');
    $('#menu-search').attr('style', 'display: block');
    $('#menu-archive').attr('style', 'display: none');
    $('#menu-folder').attr('style', 'display: none');
    $('#menu-tags').attr('style', 'display: none');
    selectTextNow = txt;
  } else {
    $('#menu-copy').attr('style', 'display: none');
    $('#menu-search').attr('style', 'display: none');
